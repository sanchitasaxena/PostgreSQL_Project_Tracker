...
1	Markov	Tweets generated from Markov chains	500
2	Blockly	Programmatic Logic Puzzle Game	10
3	SQL Quiz	teaches user how to use SQL	30
4	Madlibs	Grab words from user to play Madlibs	80
5	Flask	Create a web app using Flask	90
\.
